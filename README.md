...
- Lets you edit prompt modes, OpenAI model, timeout, temperature, writing shortcut, voice shortcut, microphone, speech preset, speech endpoint, speech model, post-transcription handling, selection translation language, AI pronunciation voice, and AI pronunciation speed.
