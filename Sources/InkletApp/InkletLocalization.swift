...
enum L10n {
    ...
    private static let zhHans: [String: String] = [
        ...
        "settings.permission.inputMonitoring": "输入监控",
        "settings.permission.inputMonitoringAuthorized": "输入监控已授权",
        "settings.permission.inputMonitoringRequired": "需要输入监控权限",
        "settings.permission.inputMonitoringDescription": "Inklet 需要该权限，才能在其他 app 处于前台时检测语音快捷键。",
        ...
        "voice.error.inputMonitoringPermission": "请为 Inklet 开启输入监控权限，才能使用语音快捷键。",
