...
enum L10n {
    ...
    private static let zhHant: [String: String] = [
        ...
        "settings.row.defaultMode": "預設模式",
        "settings.help.defaultMode": "浮窗開啟時預設選取的模式。",
        "settings.help.temperature": "數值越低越穩定，越高越發散。",
        "settings.help.timeout": "請求最長等待時間。",
        "settings.seconds": "%d 秒",
        "settings.help.provider": "目前服務商。",
        "settings.help.apiKey": "儲存到對應 provider 的 Keychain item。",
    ...
    private static let ja: [String: String] = [
        ...
        "settings.row.defaultMode": "既定のモード",
        "settings.help.defaultMode": "ポップオーバーを開いたときに選択されるモード。",
        "settings.help.temperature": "低いほど安定し、高いほど創造的になります。",
        "settings.help.timeout": "リクエストの最大待ち時間。",
        "settings.seconds": "%d 秒",
        "settings.help.provider": "現在のプロバイダー。",
        "settings.help.apiKey": "プロバイダー別の Keychain item に保存されます。",
    ...
    private static let ko: [String: String] = [
        ...
        "settings.row.defaultMode": "기본 모드",
        "settings.help.defaultMode": "팝오버를 열 때 선택되는 모드.",
        "settings.help.temperature": "낮을수록 안정적이고 높을수록 창의적입니다.",
        "settings.help.timeout": "요청 최대 대기 시간.",
        "settings.seconds": "%d초",
        "settings.help.provider": "현재 provider.",
        "settings.help.apiKey": "Provider별 Keychain item에 저장됩니다.",
    ...
    private static let es: [String: String] = [
        ...
        "settings.row.defaultMode": "Modo predeterminado",
        "settings.help.defaultMode": "Modo seleccionado al abrir el panel.",
        ...
        "settings.help.apiKey": "Guardada en el item de Keychain específico del proveedor.",
    ...
    private static let fr: [String: String] = [
        ...
        "settings.row.defaultMode": "Mode par défaut",
        "settings.help.defaultMode": "Mode sélectionné à l’ouverture du panneau.",
        ...
        "settings.help.apiKey": "Enregistrée dans l’élément Keychain du fournisseur.",
    ...
    private static let de: [String: String] = [
        ...
        "settings.row.defaultMode": "Standardmodus",
        "settings.help.defaultMode": "Modus beim Öffnen des Popovers.",
        ...
        "settings.help.apiKey": "Wird im Keychain-Item des Anbieters gespeichert.",
    ...
    private static let pt: [String: String] = [
        ...
        "settings.row.defaultMode": "Modo padrão",
        "settings.help.defaultMode": "Modo selecionado ao abrir o painel.",
        ...
        "settings.help.apiKey": "Salva no item Keychain específico do provedor.",
    ...
    private static let it: [String: String] = [
        ...
        "settings.row.defaultMode": "Modalità predefinita",
        "settings.help.defaultMode": "Modalità selezionata all’apertura del pannello.",
        ...
        "settings.help.apiKey": "Salvata nell’elemento Keychain del provider.",
